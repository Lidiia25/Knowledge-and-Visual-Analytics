#Get count of all trees in specified borough
#/get_count_by_borough/<string:borough>


#Get count of each species type in specified borough:
#/get_count_spc_by_borough/<string:borough>


#Get all information about specified borough:
#/get_all_by_borough/<string:borough>
